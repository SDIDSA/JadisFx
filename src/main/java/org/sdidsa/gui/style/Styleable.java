 ...
 * {@link org.sdidsa.gui.window.Window#setStyle(Style) Window.setStyle(Style)}
...
public interface Styleable {
	 ...
	 * {@link org.sdidsa.gui.window.Window#setStyle(Style) Window.setStyle(Style)} to
